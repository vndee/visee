...
class ToGpuCloner(Cloner, GpuClonerOptions):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["resources"] = _swigfaiss.ToGpuCloner_resources_set
    __swig_getmethods__["resources"] = _swigfaiss.ToGpuCloner_resources_get
    if _newclass:
        resources = _swig_property(_swigfaiss.ToGpuCloner_resources_get, _swigfaiss.ToGpuCloner_resources_set)
    ...
    def __init__(self, resources, device, options):
        this = _swigfaiss.new_ToGpuCloner(resources, device, options)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
